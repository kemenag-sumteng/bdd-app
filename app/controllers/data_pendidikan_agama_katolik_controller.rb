class DataPendidikanAgamaKatolikController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @data_pendidikan_agama_katolik.save
        format.html { redirect_to @data_pendidikan_agama_katolik, notice: 'Data pendidikan agama katolik telah berhasil dibuat.' }
  ...
  private
    ...
    def data_pendidikan_agama_katolik_params
      params.require(:data_pendidikan_agama_katolik).permit(:judul, :tautan)
    end
end
