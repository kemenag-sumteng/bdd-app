class InformasiPengumumanController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to informasi_pengumuman_index_url, notice: 'Informasi pengumuman telah berhasil dihapus.' }
  ...
  private
    ...
    def informasi_pengumuman_params
      params.require(:informasi_pengumuman).permit(:judul, :isi, :lampiran)
    end
end
